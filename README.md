...
Take in two 16 bit hexadecimal numbers as input, find their sum, then print “PALINDROME” if the result forms a palindrome and “NOT palindrome” otherwise. 

Explanation: Words that are the same if read from backward or forward are called palindromes. For example “1221” is a palindrome, because whether you read it from the beginning or the end, the word is the same. The sequence “1234321” is another palindrome.

Input 1 :
1201    
1111      [Here the sum will be 1312, which is not a palindrome]
...
Input 2:
1001
1001     [Here the sum will be 2002, which is  a palindrome]
